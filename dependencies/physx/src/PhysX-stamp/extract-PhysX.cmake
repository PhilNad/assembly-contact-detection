...
#
get_filename_component(filename "/home/runner/work/assembly-contact-detection/assembly-contact-detection/dependencies/physx/src/106.5-physx-5.5.1-cy.zip" ABSOLUTE)
get_filename_component(directory "/home/runner/work/assembly-contact-detection/assembly-contact-detection/dependencies/physx/src/PhysX" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-PhysX${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-PhysX${i}")
